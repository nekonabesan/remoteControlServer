...
class Request(BaseModel):
    ...
    delta_theta_a: Optional[int] = Field(None, description="", example=0)
    d_speed: Optional[int] = Field(None, description="", example=0)
    d_position: Optional[int] = Field(None, description="", example=0)
    d_aposition: Optional[int] = Field(None, description="", example=0)
    delta_theta_d: Optional[int] = Field(None, description="", example=0)
